            ...
            <div className="order-2 sm:order-1">
              <div className=" space-y-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  {/* View menu button */}
                  <div>
                    <button className="btn bg-orange-500  transition-all duration-300 hover:bg-orange-600 text-white rounded-full text-lg px-5 py-2">
                      {" "}
                      View menu{" "}
                    </button>
                  </div>
                  <div>
                    <button className="btn btn-primary btn-outline text-black hover:text-white  transition-all duration-300 hover:bg-orange-600  rounded-full px-5 py-2 text-lg">
                      Become a Chef
                    </button>
                  </div>
                </div>
            ...
            <div className="order-2 sm:order-1">
              <div className=" space-y-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  {/* View menu button */}
                  <div>
                    <button className="btn bg-green-500  transition-all duration-300 hover:bg-green-600 text-white rounded-full text-lg px-5 py-2">
                      {" "}
                      View menu{" "}
                    </button>
                  </div>
                  <div>
                    <button className="btn btn-success btn-outline text-black hover:text-white  transition-all duration-300 hover:bg-green-600  rounded-full px-5 py-2 text-lg">
                      Become a Chef
                    </button>
                  </div>
                </div>
            ...
            <div className="order-2 sm:order-1">
              <div className=" space-y-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  {/* View menu button */}
                  <div>
                    <button className="btn bg-blue-500  transition-all duration-300 hover:bg-blue-600 text-white rounded-full text-lg px-5 py-2">
                      {" "}
                      View menu{" "}
                    </button>
                  </div>
                  <div>
                    <button className="btn btn-blue btn-outline text-black hover:text-white  transition-all duration-300 hover:bg-blue-600  rounded-full px-5 py-2 text-lg">
                      Become a Chef
                    </button>
                  </div>
                </div>
